...
@EndUserText.label: 'cds publicacion'
...
define view entity ZCDS_publicacion_der 
as select from /dmo/travel as Travel
    ...
    association[1..*] to /dmo/booking as  _Booking on _Booking.travel_id = $projection.TravelId
